...
.row:after {
  ...
  clear: both;
	...
	<body class="bg">
		...
		<h1 style="font-style:italic; font-size:26pt;padding-left:30px;"><center>Borrow Book(s)</center></h1>
		...
		<div class="row">
			...
			<form action="student_issue_book_action.php" method = "get">
						...
						<h2 style="font-style:italic;color:Black">Borrowed date :</h2>
						
						<input type="date"  required  name="date" placeholder="Return date" style="width:280px;">
						<h1> </h1>
					    <input type="submit"  value="Borrow Book" style="width:280px;">
			</form>

...
.row:after {
  ...
  clear: both;
	...
	<body class="bg">
		...
		<h1 style="font-style:italic; font-size:26pt;padding-left:30px;color:white"><center>Add Books</center></h1>
		...
		<div class="row">
			...
			<form action="add_books_action.php" method = "get">
			
		            	<input type="text"  required  name="bookname" placeholder="Book Name" style="width:280px;">
						<h1></h1>
						<input type="text"  required  name="bookid" placeholder="Book Id" style="width:280px;">
						<h1> </h1>
						<input type="text"  required  name="autname" placeholder="Author Name" style="width:280px;">
						<h1> </h1>
						<input type="text"  required name="pub" placeholder=" Publisher" style="width:280px;">
						<h1></h1>
						<input type="text"  required name="qty" placeholder=" Quantity" pattern="[0-9]{1,}" style="width:280px;">
						<h1></h1>
					    <input type="submit"  value="Add Book" style="width:280px;">
			</form>
